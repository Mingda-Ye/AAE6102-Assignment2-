...
settings.fileName           = '/Volumes/T7_Shield/matlab/GPS_L1_CA_hd/GPS_L1_CA/data/Data for AAE6102/Urban.dat';%'C:\Users\gnss\Desktop\Discussion\Amungo Navigation for NUT4NT+\dump_ch1.bin';  
...
settings.IF                 = 0;%1580e6-1575.42e6;0%%10e6;%1;     % [Hz]
settings.samplingFreq       = 26e6;%26e6;        % [Hz]
...
settings.acqThreshold       = 15; % Original: 1.8
...
settings.CNo.VSMinterval = 20;


%% Multiple correlator, for multi-correlator
settings.multicorr=0;

%% Multipath Mitigation Technology (MMT) TODO(HD):-> MMT parameters
settings.DPE_cohInt= 20; % coherent time, in ms
settings.MMT=0;                % 0:off 1:on
settings.MMT_const=0.8;         % amplitude ratio multipath/direct path
settings.Sample =  ceil(settings.samplingFreq*settings.intTime);
