function [navSolutions, eph] = postNavigation_2(trackResults, settings)
...
%% Find receiver position =================================================
    ...
    if size(activeChnList, 2) > 3
        ...
        % Skymask(settings.skymask_filename,navSolutions.el,navSolutions.az,1);
        %=== Save results ===========================================================
        ...
        % % est_rec_vel=zeros(3,1);
        % [X_k, P_k]= ekf_gnss(X,P,est_rec_vel(1:3),clkCorrRawP,satPositions,settings);

        [X_k, P_k]= ekf(satPositions,clkCorrRawP,settings,X,P,Q);
